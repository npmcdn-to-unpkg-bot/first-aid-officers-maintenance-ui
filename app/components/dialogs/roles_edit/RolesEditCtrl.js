		...
		ngDialog.openConfirm({
			...
			adminSvc.setUserRoles($scope.empl.empl_pk, _.pluck(_.where($scope.roles, {checked: true}), 'role_name')).then(function (response) {
				...
				switch(response.status) {
					case 200:
						type = 'success';
						message = 'Compte cr&eacute;&eacute;&nbsp;!<br />Un mot de passe a &eacute;t&eacute; automatiquement g&eacute;n&eacute;r&eacute;&nbsp;: <strong><samp>' + response.data + '</samp></strong><hr />Veuillez transmettre son nouveau mot de passe &agrave; l\'agent concern&eacute;.';
						break;
