...
module.exports = function ($scope, $routeParams, dataSvc, trngSvc, $location, ngDialog, busySvc, dateFilter, NgTableParams, clientSvc) {
      ...
      scope: _.extend($scope.$new(false), {
        callback: function (params, close) {
          ...
          clientSvc.getBase64Logo().then(function (logo) {
            reports
              .generateSignInSheet(params, {
                  title: $scope.trng.type.trty_name + ' - ' + $scope.trng.displayDate + exportType,
