...
module.exports = function ($scope, updateSvc, ngDialog, $route) {
  $scope.create = function () {
    ...
    dialogScope.innerHtml = '&Ecirc;tes-vous s&ucirc;r(e) de vouloir <span class="text-warning">modifier</span> le site<br /><span class="text-warning">' + $scope.site.site_name +
      '</span>&nbsp;? Cette op&eacute;ration est irr&eacute;versible et prend effet imm&eacute;diatement.';
  ...
  $scope.delete = function () {
    var dialogScope = $scope.$new(false);
    dialogScope.innerHtml = '&Ecirc;tes-vous s&ucirc;r(e) de vouloir <span class="text-warning">supprimer</span> le site<br /><span class="text-warning">' + $scope.site.site_name +
      '</span>&nbsp;? Cette op&eacute;ration est irr&eacute;versible et prend effet imm&eacute;diatement.';
    ngDialog.openConfirm({
      template: 'components/dialogs/warning.html',
      scope: dialogScope
